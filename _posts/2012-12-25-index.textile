...
I wrote this library for the first time 6 or 7 years ago and keep re-writting it or enhancing it. I decided it was time to set it free and published in NuGet if for no other reason that make my own life easier.
...
Throw on first, throw a list or just get the list on hold on it for a while.